 ...
 * @author P0068839
 */
public class BACKUPDisplayEmployeeInfoJFrame extends javax.swing.JFrame {
     ...
     */
    public BACKUPDisplayEmployeeInfoJFrame() {
        initComponents();
        /*
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BACKUPDisplayEmployeeInfoJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BACKUPDisplayEmployeeInfoJFrame().setVisible(true);
            }
        });
    }
